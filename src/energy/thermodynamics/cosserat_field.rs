...
//! channel that closes the loop `matter::materials::cosserat`'s kinematics
...
//! 230, 107535. See `matter::materials::cosserat`'s own doc for the
...
use crate::{grid::kernel::quadratic_weights, matter::materials::cosserat::micro_curvature_2d};
...
pub struct CosseratConfig {
    ...
    /// `matter::materials::cosserat`'s own doc for the cited relation this
