...
/// ideal gas, same real constant already used in `energy::acoustics::
/// bubble::AIR_ADIABATIC_INDEX` for the gas trapped inside a bubble
/// (duplicated rather than cross-imported: both modules independently
/// need this well-known physical constant, no real coupling between
/// "gas as the simulated medium" and "gas trapped in a liquid" beyond
/// sharing a value).
